...
public class AllDashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        studentsBoardPane.setBackground(new java.awt.Color(204, 255, 204));
...
//                      Clsroom classRoom = classroomFactory.getClassRoom(t.getAge());
...
//            Clsroom classRoom = classroomFactory.getClassRoom(age);
...
//List<Clsroom> allClassRooms = classroomFactory.getAllClassRooms();
//            int counter = 0;
//            try {
//                for (Clsroom classroom : allClassRooms) {
//                    int tempCounter = 0;
